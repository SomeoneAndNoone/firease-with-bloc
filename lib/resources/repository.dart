...
import 'package:firebase_with_bloc/resources/firestore_provider.dart';
import 'package:firebase_with_bloc/resources/mlkit_provider.dart';
...
class Repository {
  ...
  void removeGoal(String title, email) => _firestoreProvider.removeGoal(title, email);
}
